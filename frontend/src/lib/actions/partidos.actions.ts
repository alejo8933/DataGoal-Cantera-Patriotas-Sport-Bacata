...
import { SupabaseEventoPartidoRepository } from 'datagoal-backend/modules/partidos/infrastructure/SupabaseEventoPartidoRepository'
import { SupabaseEstadisticasEventoRepository } from 'datagoal-backend/modules/partidos/infrastructure/SupabaseEstadisticasEventoRepository'
import { PartidoMapper } from 'datagoal-backend/modules/partidos/infrastructure/PartidoMapper'
import { EventoPartidoMapper } from 'datagoal-backend/modules/partidos/infrastructure/EventoPartidoMapper'
import { GetPartidosUseCase } from 'datagoal-backend/modules/partidos/use-cases/GetPartidosUseCase'
import { GetPartidoByIdUseCase } from 'datagoal-backend/modules/partidos/use-cases/GetPartidoByIdUseCase'
import { CreatePartidoUseCase } from 'datagoal-backend/modules/partidos/use-cases/CreatePartidoUseCase'
import { UpdatePartidoUseCase } from 'datagoal-backend/modules/partidos/use-cases/UpdatePartidoUseCase'
import { GetEventosPartidoUseCase } from 'datagoal-backend/modules/partidos/use-cases/GetEventosPartidoUseCase'
import { RegistrarEventoPartidoUseCase } from 'datagoal-backend/modules/partidos/use-cases/RegistrarEventoPartidoUseCase'
import { EliminarEventoPartidoUseCase } from 'datagoal-backend/modules/partidos/use-cases/EliminarEventoPartidoUseCase'
import type {
  EquipoEventoPartido,
  TipoEventoPartido,
} from 'datagoal-backend/modules/partidos/domain/entities/EventoPartidoEntity'
import type { PartidoResponseDTO } from 'datagoal-backend/modules/partidos/dtos/PartidoResponseDTO'
import type { EventoPartidoResponseDTO } from 'datagoal-backend/modules/partidos/dtos/EventoPartidoResponseDTO'
