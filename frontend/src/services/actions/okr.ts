...
import { SupabaseOKRRepository } from 'datagoal-backend/modules/okr/infrastructure/SupabaseOKRRepository'
import { GetOKRsUseCase } from 'datagoal-backend/modules/okr/use-cases/GetOKRsUseCase'
import { UpsertOKRUseCase } from 'datagoal-backend/modules/okr/use-cases/UpsertOKRUseCase'
import { AddKRUseCase } from 'datagoal-backend/modules/okr/use-cases/AddKRUseCase'
import { DeleteOKRUseCase } from 'datagoal-backend/modules/okr/use-cases/DeleteOKRUseCase'
import type { ObjetivoOKREntity, KRProps } from 'datagoal-backend/modules/okr/domain/entities/ObjetivoOKREntity'
import { SupabaseFacturaRepository } from 'datagoal-backend/modules/finanzas/infrastructure/SupabaseFacturaRepository'
import { CalcularEficaciaRecaudacionUseCase } from 'datagoal-backend/modules/finanzas/use-cases/CalcularEficaciaRecaudacionUseCase'
